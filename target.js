(function ($R) {
	...
	$R.path = 'https://cdn.rawgit.com/punalex/readable/master/';
	$R.linksPath = 'https://cdn.rawgit.com/punalex/readable/master/';
	...
	var	
		...
		_custom = 
		{
				...
				'en.m.wikipedia.org': 		[[/^\/wiki\//i, 			'js: wikipedia_en']],
				'tieba.baidu.com':          [[/^\//i,                   'jq: ul#pblist.list']],
